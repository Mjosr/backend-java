...
public class ActivoRepository {
    ...
    public ActivoRepository(Firestore db) { this.db = db; }
    private CollectionReference getCollection() { return db.collection("activos"); }
    ...
    public List<Activo> findAll() {
        ...
        try {
            ...
            for (QueryDocumentSnapshot doc : future.get().getDocuments()) {
                Activo objeto = doc.toObject(Activo.class);
    ...
    public Activo save(Activo objeto) {
